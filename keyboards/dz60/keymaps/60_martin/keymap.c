...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BL] = LAYOUT_60_martin(
        ...
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_CL,          MO(_CL),
	...
	[_FL] = LAYOUT_60_martin(
		...
		_______,          KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, KC_INS,  KC_HOME,  KC_GRV, _______,
		_______,          _______, _______, _______, _______, _______, _______, _______, _______, KC_END,  KC_PGDN,            KC_UP, _______,

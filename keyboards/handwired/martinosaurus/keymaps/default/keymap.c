...
[_BASE] = LAYOUT_martinosaurus(
        ...
        KC_TAB,     KC_Q,    KC_W,    KC_E,       KC_R,    KC_T,                   KC_Y,    KC_U,        KC_I,    KC_O,    KC_P,    KC_BSPC, //KC_BSLS, // KC_RBRC, KC_BSLS,
        KC_BSLS,    KC_A,    KC_S,    KC_D,       KC_F,    KC_G,                   KC_H,    KC_J,        KC_K,    KC_L,    KC_SCLN, KC_QUOT, //         KC_ENT,
...
[_RAISE] = LAYOUT_martinosaurus(
        ...
        _______, KC_F12,  KC_LPRN, KC_RPRN, _______, _______,                _______, _______, KC_INS,  KC_LBRC, KC_RBRC, KC_DEL, // KC_EQL,  // KC_PSCR, KC_RBRC,KC_SLCK, //KC_PAUS, RESET,
        KC_CAPS, _______, KC_LCBR, KC_RCBR, _______, _______,                KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_GRV,  // _______,
...
[_LOWER] = LAYOUT_martinosaurus(
        ...
        _______, _______, _______, _______, _______, TG(_CS),                KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_EQL,

...
[_BASE] = LAYOUT_martinosaurus(
        ...
        KC_LCTL,    KC_LGUI, KC_LALT, MO(_LOWER),     KC_SPC,                      KC_BSPC, KC_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
[_RAISE] = LAYOUT_martinosaurus(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  // KC_F12,           KC_DEL,
        _______, KC_F12,  _______, _______, _______, _______,                _______, _______, KC_INS,  KC_LBRC, KC_RBRC, KC_EQL,  // KC_PSCR, KC_RBRC,KC_SLCK, //KC_PAUS, RESET,
...
[_LOWER] = LAYOUT_martinosaurus(
        ...
        _______, _______, _______, _______, _______, _______,                KC_LPRN, KC_MINS, KC_EQL,  KC_RPRN, _______, KC_BSLS,
        KC_CAPS, _______, _______, _______, _______, _______,                KC_LCBR, _______, _______, KC_RCBR, _______, _______,
        _______, _______, _______, _______, _______, _______,                KC_LBRC, _______, _______, KC_RBRC, _______, _______,

...
[_RAISE] = LAYOUT_martinosaurus(
        ...
        _______, _______, KC_LBRC, KC_RBRC, _______, _______,                _______, _______, _______, _______, _______, _______, // _______,
...
[_LOWER] = LAYOUT_martinosaurus(
        ...
        KC_DEL,  _______, _______, _______, _______, TG(_CS),                KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_EQL,

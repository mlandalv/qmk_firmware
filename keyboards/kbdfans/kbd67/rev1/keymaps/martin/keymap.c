...
[DEF] = LAYOUT_65_martin(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_CAPS,       KC_SPC,    KC_LCTL,              KC_RALT, MO(1),   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),

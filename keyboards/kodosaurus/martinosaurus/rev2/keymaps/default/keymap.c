...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_125(
            ...
            _______, _______, _______, _______, MO(_DN), _______,                _______, _______, _______, _______, _______, _______
    ),
    [_LOWER] = LAYOUT_125(
            ...
            _______, _______, _______, _______, _______, _______,                _______, MO(_DN), KC_HOME, KC_PGDN, KC_PGUP, KC_END
    ),
    [_DN] = LAYOUT_125(
            RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
            _______, KC_F12,  KC_LPRN, KC_RPRN, _______, _______,                _______, _______, _______, _______, _______, _______,
            KC_DEL,  _______, KC_LCBR, KC_RCBR, _______, _______,                _______, _______, _______, _______, _______, _______,
            _______, _______, KC_LBRC, KC_RBRC, _______, _______,                _______, _______, _______, _______, _______, _______,
